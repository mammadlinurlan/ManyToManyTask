...
namespace ManyToManyTask.Migrations
{
    ...
    [Migration("20211226205540_createdLinksInContact")]
    partial class createdLinksInContact
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ManyToManyTask.Models.Contact", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ManyToManyTask.Models.PricingCard", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ManyToManyTask.Models.PricingCardFeatures", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("PricingCardFeatures");
                });

            modelBuilder.Entity("ManyToManyTask.Models.PricingFeature", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ManyToManyTask.Models.Question", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ManyToManyTask.Models.PricingCardFeatures", b =>
                {
                    b.HasOne("ManyToManyTask.Models.PricingCard", "PricingCard")
                        .WithMany("PricingCardFeatures")
                        .HasForeignKey("PricingCardId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ManyToManyTask.Models.PricingFeature", "PricingFeature")
                        .WithMany("PricingCardFeatures")
